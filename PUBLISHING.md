...
The orange, pink and navy sets use modelled main images, with the real store photos retained in their galleries. The navy set is two pieces only, with no scarf/dupatta. The AI-styling explanation appears separately in the product details, not on top of the photos. The remaining concept styles are labelled as illustrative previews. Orders and enquiries go through your two WhatsApp numbers; the website does not collect payments or automatically confirm orders.
