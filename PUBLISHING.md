...
All four supplied sets now use modelled main images, with real store-photo galleries. Orange and pink are three-piece sets; navy and green are two-piece sets without a scarf/dupatta. No placeholder product cards remain. The AI-styling explanation appears separately in the product details, not on top of the photos. The campaign and inspiration moodboard remain illustrative, separately from the actual product collection. Orders and enquiries go through your two WhatsApp numbers; the website does not collect payments or automatically confirm orders.
